...
echo "Способности Pure Blood" > lab0/hitmontop8/dragonite
echo "Mach Speed Inner Focus White Smoke" >> lab0/hitmontop8/dragonite
...
echo "Возможности Overland=10 Surface=7 Jump=3 Power=3" > lab0/linoone9
echo "Intelligence=4 Tracker=0" >> lab0/linoone9
echo "Тип покемона GROUNG" > lab0/rhyhorn9
echo "ROCK" >> lab0/rhyhorn9
mkdir lab0/togepi9
touch lab0/togepi9/dragonite
echo "Способности Pure Blood" > lab0/togepi9/dragonite
echo "Mach Speed Inner Focus White Smoke" >> lab0/togepi9/dragonite
mkdir lab0/togepi9/kricketot
mkdir lab0/togepi9/happiny
touch lab0/togepi9/tranquill
echo "Тип покемона" > lab0/togepi9/tranquill
echo "NORMAL FLYING" >> lab0/togepi9/tranquill
touch lab0/togepi9/swadloon
echo "weight=16.1 height=20.0 atk=6 def=9" > lab0/togepi9/swadloon